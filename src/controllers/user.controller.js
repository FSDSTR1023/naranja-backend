...
import { sendNewPassword } from '../services/mailing.js'
...
export const autogeneratedPassword = async (req, res) => {
  const { email } = req.body
  const newPassword = Math.floor(Math.random() * 1000000).toString()
  ...
  try {
    ...
    console.error(error, '[ERROR AUTOGNERATED PASSWORD]')
